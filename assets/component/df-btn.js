...
if (!config.project){
    ...
    document.write(`
        <button class="df-btn df-closed" onclick="dfToggle()">
            <div class="df-btn-text"><strong>${greetings[greeting_id]}</strong></div>
            <iframe class="df-btn-content" src="AI.html" ></iframe>
        </button>
    `)
    ...
    window.dfToggle = () => {
        ...
        document.querySelector('.df-btn-text').innerText = dfToggled ? (config.openText) : (config.closeText || 'Close')
